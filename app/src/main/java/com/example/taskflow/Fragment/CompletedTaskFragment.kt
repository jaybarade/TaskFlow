...
import com.example.taskflow.databinding.FragmentCompletedTaskBinding
...
class CompletedTaskFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val completedList = dbHelper.getTasksByStatus(1)
        ...
        adapter = TaskAdapter(
            ...
            onDeleteClicked = { task ->
                ...
                refreshList()
                    ...
                    onEditClicked = { task ->
                showUpdateTaskDialog(task)   // 👈 yahan dialog open hoga
            }
    ...
    private fun refreshList() {
        val updatedList = dbHelper.getTasksByStatus(1)
